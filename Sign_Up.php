...
<link href="https://use.fontawesome.com/releases/v5.0.4/css/all.css" rel="stylesheet"></script>
...
<div id="abc" >
    <nav>      
        <ul>
            ...
            <li class="topnav-right"><a href="#">Home</a></li>
        </ul>
    </nav>
</div>
...
<div class="container" id="container">
	<div class="form-container sign-up-container">
		<form action="#">
            ...
            <br>
            <span>or register through your google account</span>
            
            <div class="social-container">
            <a href="#" class="social"><i class="fab fa-google-plus-g"></i></a> Sign Up with Google
			</div>
	...
	<div class="form-container sign-in-container">
		<form action="Add_Notes.php">
            ...
            <br>
            <span>or login through your google account</span>
            
            <div class="social-container">
				
	<a href="#" class="social"><i class="fab fa-google-plus-g"></i></a> Sign In with Google
